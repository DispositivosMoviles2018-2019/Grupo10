...
public class Registro extends AppCompatActivity {
   ...
   // Boolean validaEmail=false;
    ...
    if ( nuevo.setEmail(email,editEmail)==true&&
        ...
        //parte guardar con preferencias
        SharedPreferences sharpref = getSharedPreferences("ArchivoSP",Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = sharpref.edit();
        Gson gson = new Gson();

        String usuario = gson.toJson(nuevo.getUsuario());
        String clave = gson.toJson(nuevo.getClave());
        String nombre = gson.toJson(nuevo.getNombre());
        String apellido = gson.toJson(nuevo.getApellido());
        String celular = gson.toJson(nuevo.getCelular());
        String email = gson.toJson(nuevo.getEmail());
        String genero = gson.toJson(nuevo.getGenero());
